        ...
        {services.map((service, index) => (
          ...
          >
            <div className="flex items-center gap-1 mb-4 pl-5 lg:pl-0">
              ...
              />
              <div className="w-8 h-8 lg:w-12 lg:h-12 flex items-center justify-center rounded-full bg-white group-hover:bg-black group-hover:text-white transition-all duration-500">
